...
class Game:
    ...
    def init_cars(self, player_car_sprite: int) -> None:
        ...
        self.cars.append(EnemyCar1(self, sprites.pop(), self.map.waypoints, 0.2))
        self.cars.append(EnemyCar2(self, sprites.pop(), self.map.waypoints, 0.2))
        self.cars.append(EnemyCar3(self, sprites.pop(), self.map.waypoints, 0.2))
        self.cars.append(EnemyCar4(self, sprites.pop(), self.map.waypoints, 0.2))
